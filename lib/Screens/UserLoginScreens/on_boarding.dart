    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children:  [
            ...
            MyText(text: ' eShoppie', size: K_fontSizeL,color: K_whiteColor,)
          ],
        ),
      ),
      floatingActionButton: Padding(
        ...
        child: AnimatedContainer(
          width: index != 3 ? 60 : 100,//Will be changed if we reached to the last page
          duration: const Duration(milliseconds: 200),
          child: FloatingActionButton(
            onPressed: () async{
              if(index < pages.length-1) {
                pageController.animateToPage(index+1, duration: const Duration(seconds: 2), curve: Curves.fastLinearToSlowEaseIn);
              }
              else {
            ...
            child: index != 3 ? const Icon(CupertinoIcons.arrow_right,color: K_blackColor,) :
            MyText(text: 'Sign up', size: K_fontSizeL-2,fontWeight: FontWeight.normal,),
              ...
              child: Column(
                ...
                children: [
                  TextButton(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.only(bottom: K_mainPadding,),
                      child: MyText(text: 'Skip', size: K_fontSizeL,color: K_greyColor,fontWeight: FontWeight.normal,),
                    ),
                  ),
                ],
              ),
